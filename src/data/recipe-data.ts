...
export const RECIPE_DATA: Record<string, RecipeData> = {
  ...
  "ricette/menrui/tomato_to_tsuna_no_hiyashi_somen": {
    ...
    "image": "/img/ricette/somen_freddi_tonno_pomodoro.jpg",
    "recipeCategory": "Noodles",
    "recipeKeywords": [
      "somen",
      "tsuyu",
    ...
    "recipeIngredient": [
      ...
      "Shio Kombu",
      "Tsuyu concentrato multiuso",
      "Acqua e ghiaccio"
    ],
    "instructionsText": "Iniziamo preparando il condimento per la nostra pasta: tagliamo i pomodori a cubetti e lo shiso a striscioline sottili. In una ciotola, uniamo i pomodori, il tonno in scatola sbriciolato con le mani, lo shiso e un'aggiunta di shio kombu, che darà a tutto il piatto \"quel calcetto di umami in più\". Prepariamo ora il brodo ghiacciato che andrà a condire il piatto: in una ciotolina mettiamo dei cubetti di ghiaccio e versiamo lo tsuyu, diluendolo con l'acqua in proporzione 5 a 1. Passiamo alla cottura della pasta. Facciamo bollire i somen in acqua: ci vorrà pochissimo tempo. Una volta pronti, li scoliamo e li laviamo molto bene sotto l'acqua corrente, dopodiché facciamo fare loro un tuffo immediato in una ciotola con acqua e ghiaccio. Questo shock termico farà in modo che i somen rimangano belli al dente. Non ci resta che \"urlare all'assemblaggio\" e mettere tutto insieme in un piatto fondo o in una ciotola: disponiamo i somen ben scolati, aggiungiamo sopra il nostro condimento di tonno e verdure e, soprattutto, inondiamo il tutto con il brodo ghiacciato. La vostra pasta fredda giapponese è pronta: una vera bomba da accompagnare con una birra fredda!",
    "videoIds": [
      "jkbb8aukEuk"
    ],
  ...
  "ricette/riso/gohan": {
    ...
    "image": "/img/ricette/ciotola-di-riso.jpg",
    "recipeCategory": "Riso",
    "recipeKeywords": [
      "rice"
    ],
    ...
    "instructionsText": "Il primo passo fondamentale è la scelta del riso. Dimenticate le varietà nostrane come Carnaroli o Arborio, e anche quelle orientali come Basmati o Jasmine (che si cuociono per assorbimento ma non sono adatte alla cucina giapponese). Orientatevi su varietà Japonica o, più semplicemente, sul comunissimo riso Originario, che si trova in ogni supermercato. È essenziale misurare la quantità di riso con estrema precisione: anche pochi millimetri in più o in meno nel misurino possono alterare il risultato finale. Una volta misurato, il riso va lavato accuratamente. Questo passaggio è cruciale e richiede delicatezza: non dovete assolutamente sfregare i chicchi tra loro, altrimenti si romperanno. Utilizzate la mano \"a rastrellino\", muovendola circolarmente nell'acqua, poi scolate e ripetete l'operazione dalle 3 alle 10 volte, finché l'acqua di risciacquo non risulterà quasi trasparente. Dopo l'ultimo risciacquo, scolate il riso senza lasciarlo in ammollo, per limitare di introdurre altre variabili. La scelta della pentola è altrettanto importante. Evitate pentole in alluminio (sia normali che smaltate); l'ideale è una pentola in acciaio con il fondo molto spesso o una cocotte in ghisa. Versate il riso lavato nella pentola e aggiungete un misurino pieno d'acqua, più circa mezzo centimetro aggiuntivo (questa è la quantità ideale, ma dovrete imparare a conoscere il vostro riso per affinare la dose). Mettete il coperchio, che non dovrà mai essere tolto per tutta la durata della cottura. Accendete il fuoco al massimo. Dovrete fare affidamento al vostro udito e alla vista: quando sentirete il rumore dell'acqua in ebollizione e vedrete uscire un po' di vapore dal coperchio, abbassate immediatamente la fiamma al minimo. A partire da questo momento, lasciate cuocere per esattamente 10 minuti. Trascorsi i 10 minuti, spegnete il fuoco e, sempre senza aprire il coperchio, lasciate riposare il riso per altri 15 minuti: questo tempo è necessario per completare la cottura a vapore. Finalmente potete togliere il coperchio. Se avete seguito tutti i passaggi, il riso sarà sgranato, lucido e non si sarà incollato o bruciato sul fondo. Tuttavia, come abbiamo visto, questo metodo richiede attenzione costante; se volete un risultato garantito e meno stress, il consiglio è sempre quello di affidarsi a una cuociriso!",
    "videoIds": [
      "Dwru1wxbBek"
    ],
    "datePublished": "2026-05-18T12:11:41+02:00"
  },
  "ricette/riso/gyudon": {
  ...
  "ricette/riso/onigiri_sakura_ebi": {
    "docId": "ricette/riso/onigiri_sakura_ebi",
    ...
    "image": "/img/ricette/onigiri_sakura_ebi.jpg",
    "recipeCategory": "Riso",
    "recipeKeywords": [
      "rice",
      "sesamo",
    ...
    "recipeYield": null,
    "recipeIngredient": [
      "Riso bianco caldo per onigiri",
      "Sakura Ebi (microgamberetti rosa secchi)",
      "Erba cipollina fresca tritata",
      "Semi di Sesamo",
      "Salsa di soia (Shoyu)",
      "Shio Kombu (alga kombu sotto sale)",
      "Acqua e sale per la formatura"
    ],
    "instructionsText": "Per iniziare, versate il riso caldo appena cotto in una ciotola capiente. Aggiungete i delicati Sakura Ebi, l'erba cipollina fresca tritata, una spolverata di semi di sesamo e un filo di salsa di soia. Con l'aiuto di una spatola (shamoji), mescolate il tutto con cura. È fondamentale utilizzare un movimento \"convettivo\", dal basso verso l'alto, per non schiacciare i chicchi di riso. Aggiungete anche lo shio kombu, che agirà da vero e proprio \"turbo\" per il sapore, donando una spinta di umami incredibile. Mescolate nuovamente fino a distribuire tutti gli ingredienti in modo uniforme. Ora è il momento di formare gli onigiri. Bagnatevi le mani con dell'acqua e salatele abbondantemente. Prelevate una porzione di riso condito (se lo desiderate, potete aggiungere un cuore di prugna umeboshi al centro) e chiudetela delicatamente. Iniziate a \"striangolare\" la polpetta tra i palmi delle mani per darle la classica forma. I vostri onigiri ai Sakura Ebi sono pronti per essere gustati o confezionati per un pranzo fuori casa!",
    "videoIds": [
      "3kV_q6itqko"
    ],
  ...
  "ricette/sides/mugen_piiman": {
    ...
    "datePublished": "2026-08-03T16:57:46+02:00"
  },
  ...
  "ricette/yakimono/negi_shio_remon_chikin": {
    ...
    "datePublished": "2026-08-10T15:06:00+02:00"
  },
  ...
  "ricette/yakimono/takenoko_niku_miso": {
    ...
    "instructionsText": "Per iniziare, sgrattugiamo finemente uno spicchio d'aglio e un pezzetto di zenzero fresco per creare la nostra base aromatica. In un padellino, scaldiamo dolcemente un po' di olio di sesamo e uniamo la nostra base di aglio e zenzero. Aggiungiamo la carne trita (che può essere di pollo o di maiale, a vostra scelta) e le fettine di takenoko. : A questo punto inseriamo i condimenti principali: un cucchiaio di miso e un cucchiaio di salsa tonkatsu. Procediamo con delle spadellate vigorose nel movimento ma sempre a fiamma dolce, lasciando che i liquidi si restringano piano e vengano assorbiti dalla carne e dal bambù. Una volta che il piatto è ben caramellato e ristretto, lo trasferiamo in una ciotola per servirlo. Per completare l'opera, guarniamo con le immancabili cipolline fresche tritate e aggiungiamo qualche goccia di raiu, l'olio al sesamo piccante che farà impazzire le vostre papille gustative. Buon appetito, o per meglio dire, Itadakimasu!",
    "videoIds": [
      "0CdyqA8cCfQ"
    ],
