export const INGREDIENT_RECIPE_INDEX = {
  ...
  "shoyu": [
    ...
    {
      "id": "ricette/riso/onigiri_sakura_ebi",
  ...
  "wakame": [
    ...
    {
      "id": "ricette/zuppe/vegan-misoshiru",
  ...
  "senape karashi": [
    {
      "id": "ricette/tsukemono/kyuri-no-tsukemono",
      "title": "Kyuri no Tsukemono",
      "description": "Cetrioli sottaceto veloci",
      "permalink": "/ricette/kyuri_no_tsukemono"
    }
  ],
  "miso": [
    {
